...
model_path = os.path.join(script_dir, 'hand_gesture_model_svm.pkl')
                ...
                try:
                    ...
                    if model_loaded:
                        try:
                            ...
                            # Only accept predictions with confidence above 0.5 (50%)
                            ...
                            if max_prob > 0.5:
                                ...
                                # If no class has confidence above 50%, don't recognize any gesture
                                prediction = 0
                            ...
                            for i, prob in enumerate(probabilities):
                                if prob > 0.05:  # Only display significant probabilities
                                    ...
                                    text_color = (0, 0, 255) if prob > 0.5 else (255, 0, 0)
